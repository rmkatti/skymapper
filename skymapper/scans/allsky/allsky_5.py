...
def allsky_survey(pointing_file):
    ...
    sum_plot_days=[2,8,10,31, 45, 92,183,274,365]
    least_plot_days=[10,31, 45,92,183,274,365]
    ...
    for day in days:
        ...
        for i, tupler in enumerate(points_in):
            ...
            if (day in least_plot_days) & (i==0):
                ...
                moll_plot(theta_in, phi_in, hits_in , "least_allsky: Day %s"%(day-1), "least_allsky_4_day_%s" %(day-1))
