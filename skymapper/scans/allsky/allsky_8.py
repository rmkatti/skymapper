...
from skymapper.visualize.plot_points import moll_plot, moll_plot2
    ...
    for day in days:
        ...
        for i, tupler in enumerate(points_in):
            ...
            if (day in least_plot_days) & (i==0):
                ...
                moll_plot(theta_in, phi_in, hits_in , "least_allsky: Day %s"%(day-1), "least_allsky_8_day_%s" %(day-1))
            ...
            if (day in sum_plot_days) & (i==0):
                ...
                moll_plot2(theta_in, phi_in, hits_in , "sum_allsky: Day %s"%(day-1), "sum_allsky_8_day_%s" %(day-1))
