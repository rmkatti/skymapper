...
def deepsky_date_survey(save_suffix):
    ...
    savedir = os.path.join(dir, '../../data/deepsky_test/date1_s2/')
    ...
    for day in days:
        ...
        if day in plot_days:
            for j,tupler in enumerate(plot_lambda_ranges):
                ...
                savename2="date1_s2_%s_%s" %(day,tupler)
