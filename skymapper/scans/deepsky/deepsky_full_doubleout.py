...
from skymapper.analyze.an_tools import lam_dict_to_array
...
if __name__=='__main__':
    ...
    rel_save_location = '../../data/deepsky_test/test/'
    gen_name = 'Test'
    save_suffix=gen_name

    deepsky_date_survey( save_suffix, gen_name, rel_save_location)
