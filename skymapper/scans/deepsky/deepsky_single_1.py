...
def deepsky_date_survey(save_suffix):
    ...
    savedir = os.path.join(dir, '../../data/deepsky_test/deepsky_single1/')
    ...
    sub_ind=0
    subplot_days=[1, 90, 182, 364]
    #subplot_days=[1,3,7,10]
    plot_days=[1,2, 90, 182, 270, 364]
...
def gen_deepskydate1_points():
    ...
    Num_long=24
    Num_out=36
    theta_long_1=FOV_Dim/2.0
    theta_long_2=-FOV_Dim/2.0
    theta_out_1= 18*Strip_width
    theta_out_2=-18*Strip_width
    ...
    for day in days:
        ...
        list1= gen_deep3(0, phi,theta_long_1, theta_long_2, Num_long)
...
if __name__=='__main__':
    ...
    time1=time.time()
    deepsky_date_survey( 'deep_single_1')
