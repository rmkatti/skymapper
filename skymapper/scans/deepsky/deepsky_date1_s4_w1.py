...
def deepsky_date_survey(save_suffix):
    ...
    savedir = os.path.join(dir, '../../data/deepsky_test/date1_s4_w1/')
    ...
    for day in days:
        ...
        if day in plot_days:
            for j,tupler in enumerate(plot_lambda_ranges):
                ...
                savename2="date1_LOWRES_s4_w1_%s_%s" %(day,tupler)
    ...
    fig_sub.savefig( savedir + "%s.png" %("MultiPanel_date1_LOWRES_s1") )   
...
def gen_deepskydate1_points():
    ...
    for day in days:
        ...
        if day % 2==1:
            list_m1= gen_deep3(cent_line_dist, phi,theta_long_1, theta_long_1/2.0, Num_long)
            list_m2= gen_deep3(cent_line_dist, phi,theta_long_1/2.0, 0, Num_long)
            list_m2 *=3
        ...
        if day % 2 == 0:
            list_m3= gen_deep3(cent_line_dist, phi, 0, theta_long_2/2.0, Num_long)
            list_m4= gen_deep3(cent_line_dist, phi, theta_long_2/2.0, theta_long_2, Num_long)
            list_m3 *=3
        ...
        point_list_i= points_to_nparray(day, list_m1+list_m2+list_m3+list_m4+list_o2+list_o1)
...
if __name__=='__main__':
    ...
    time1=time.time()
    deepsky_date_survey( 'date1_s4_w1')
